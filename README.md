# genpark-llm-distributed-trace-latency-bottleneck-detector-skill
...
> **GenPark AI Agent Skill** -- LLM distributed trace analyzer & latency bottleneck detector (TraceLLM style)
